            ...
            <div class="form-group">
                ...
                <div class="row" style="margin-top: 30px;">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" style="width: 400px; padding: 9px;" value="<?php echo $nome ?>" readonly>
                    </div>
                </div>
                <div class="row" style="margin-top: 40px;">
                    <div class="col">
                        <label for="">Valor Pagar:</label>
                        <input type="text" class="form-control" style="width: 200px; padding: 9px;" value="<?php echo "R$" . $valorpagar ?>" readonly>
                    </div>
                    <div class="col">
                        <label for="">Data Pagar:</label>
                        <input type="date" class="form-control" style="width: 200px; padding: 9px;" value="<?php echo $datapagar ?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control"
                            style="width: 200px; padding: 9px;" readonly value="<?php echo "R$" . $valorpago ?>">
                    </div>
                    <div class="col">
                        <label for="">Data Pago:</label>
                        <input type="date" class="form-control" style="width: 200px; padding: 9px;" value="<?php echo $datapago ?>" readonly>
                    </div>
                </div>
                ...
                <div class="container" style="margin-top: 40px;">
                    <div class="row">
                        <div class="col" style="margin-bottom: 30px;">
                            ...
                            <?php
                            echo "<a href='conupdatesai.php?updateid={$row['id']}' style='color:white;'>
                        <button type='button' style='padding: 9px; width: 100px;'
                                class='btn btn-secondary'>Alterar</button></a>
                        <a href='condeletesai.php?deleteid={$row['id']}' style='color:white;'>
                        <button type='button' style='padding: 9px; width: 100px;'
