...
include('connect.php');
$id = $_GET['selectid'];
$sql = 'SELECT e.id, p.nome, replace(e.valor, ".", ",") valor, e.dataentrada, e.datadocumento, e.documento FROM ip_entrada e INNER JOIN ip_pessoa p ON p.id = e.idpessoa where e.id =' . $id;
            ...
            <div class="container" style="margin-top: 40px;">
                <div class="row">
                    <div class="col" style="margin-bottom: 30px;">
                        ...
                        <?php
                        echo "<a href='entupdate.php?updateid={$row['id']}' style='color:white;'>
                        <button type='button' style='padding: 9px; width: 100px;'
                                class='btn btn-secondary'>Alterar</button></a>
                        <a href='entdelete.php?deleteid={$row['id']}' style='color:white;'>
                        <button type='button' style='padding: 9px; width: 100px;'
