...
if (isset($_POST['submit'])) {
    ...
    $sql = 'insert into ip_entrada (idpessoa, valor, dataentrada, datadocumento, documento) values ("' . $idpessoa . '","' . $valor . '","' . $dataentrada . '","' . $datadocumento . '","' . $documento . '")';
    echo $sql;
    // executar o sql
            ...
            <div class="form-group">
                ...
                <div class="row" style="margin-top: 30px;">
                    <div class="col">
                        ...
                        <?php
                        $sql = 'select * from ip_pessoa order by id';
                        $result = mysqli_query($con, $sql);
                        if ($result) {
                ...
                <div class="row" style="margin-top: 40px;">
                    <div class="col">
                        ...
                        <input type="number" step=".01" name="valor" class="form-control" style="width: 400px; padding: 9px;">
                    </div>
                    <div class="col">
                        <label for="">Documento:</label>
                        <input type="text" name="documento" class="form-control" style="width: 400px; padding: 9px;">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="date" name="dataentrada" class="form-control" style="width: 200px; padding: 9px;">
                    </div>
                </div>
            </div>
