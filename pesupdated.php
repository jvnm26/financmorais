...
if (isset($_POST['submit'])) {
    ...
    $sql = 'update ip_pessoa set nome="' . $nome . '", tipo="' . $tipo . '", cep="' . $cep . '", logradouro="' . $logradouro . '", numero="' . $numero . '", bairro="' . $bairro . '", cidade="' . $cidade . '", uf="' . $uf . '", email="' . $email . '", telefone="' . $telefone . '", complemento="' . $complemento . '", datanascimento="' . $datanascimento . '", databatizado="' . $databatizado . '" where id=' . $id;
    // executar o sql
    $result = mysqli_query($con, $sql);
    // voltar para o menu
    if ($result) {
        header("location: pesselected.php?selectid={$row['id']}");
    } else {
            ...
            <div class="container" style="margin-top: 40px;">
                <div class="row">
                    <div class="col" style="margin-bottom: 30px;">
                        <a href="pesselect.php"><button type="button" style="padding: 9px; width: 130px;"
