...
include('connect.php');
$sql = "SELECT f.id id, f.nome nome, f.telefone telefone, f.observacao observacao FROM ip_fornecedor f ORDER BY 1";
$pesqnome = '';
if (isset($_POST['submit'])) {
    $pesqnome = $_POST['pesqnome'];
    $sql = "SELECT f.id id, f.nome nome, f.telefone telefone, f.observacao observacao 
    FROM ip_fornecedor f
        ...
        <div class="container" style="margin-top: 40px;">
            <div class="jumbotron text-center">
                ...
                <div class="row" style="margin-top: 35px;">
                    ...
                    <div class="col">
                        <a href="forinsert.php"><button type="button" style="padding: 7px; width: 100px;"
                                class="btn btn-secondary">INCLUSÃO</button></a>
                    </div>
                    <div class="col-5 text-left">
                        <a href="forselect.php"><button type="button" style="padding: 7px; width: 100px;"
            ...
            <td>
            <a href='forselected.php?selectid={$row['id']}' style='color:white;'>
                        <button type='button' class='btn btn-secondary'> 
                        Ver Mais</button></a>
            </td>
            <td>
                        <a href='forupdated.php?updateid={$row['id']}' style='color:white;'>
                        <button type='button' class='btn btn-dark'> 
                        Alterar</button></a>
                        <a href='fordeleted.php?deleteid={$row['id']}' style='color:white;'>
                        <button type='button' class='btn btn-dark'> 
                        Excluir</button></a>
            </td>
          </tr>";
