...
if (isset($_POST['submit'])) {
    ...
    $sql = 'update ip_fornecedor set nome="' . $nome . '", telefone="' . $telefone . '", observacao="' . $observacao . '" where id=' . $id;
    // executar o sql
    $result = mysqli_query($con, $sql);
    // voltar para o menu
    if ($result) {
        header("location: forselected.php?selectid={$row['id']}");
    } else {
            ...
            <div class="form-group">
                <div class="row" style="margin-top: 30px;">
                    ...
                    <div class="col">
                        ...
                        <input type="number" name="telefone" class="form-control" style="width: 400px; padding: 9px;" value="<?php echo $telefone ?>">
                    </div>
                </div>
